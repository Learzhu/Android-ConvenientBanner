...
/**
 * RoundedCornerImageView.java是液总汇的类。
 *
 * @author Learzhu
 * @version 2.0.0 2019/4/23 20:55
 * @update Learzhu 2019/4/23 20:55
 * @updateDes
 * @include {@link }
 * @used {@link }
 */
public class RoundedCornerImageView extends AppCompatImageView {
    ...
    private void initAttrs(AttributeSet attrs) {
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.RoundedCornerImageView);
        //  半径
        radius = ta.getDimension(R.styleable.RoundedCornerImageView_radius, 0);
        topLeftRadius = ta.getDimension(R.styleable.RoundedCornerImageView_topLeftRadius, 0);
        topRightRadius = ta.getDimension(R.styleable.RoundedCornerImageView_topRightRadius, 0);
        bottomLeftRadius = ta.getDimension(R.styleable.RoundedCornerImageView_bottomLeftRadius, 0);
        bottomRightRadius = ta.getDimension(R.styleable.RoundedCornerImageView_bottomRightRadius, 0);
        //  展示类型
        styleType = ta.getInt(R.styleable.RoundedCornerImageView_scaleType, TOP);
        //  描边
        borderWidth = ta.getDimension(R.styleable.RoundedCornerImageView_borderWidth, 0);
        borderSpace = ta.getDimension(R.styleable.RoundedCornerImageView_borderSpace, 0);
        borderColor = ta.getColor(R.styleable.RoundedCornerImageView_borderColor, Color.WHITE);

        //  不常用属性
        topLeftRadius_x = ta.getDimension(R.styleable.RoundedCornerImageView_topLeftRadius_x, 0);
        topLeftRadius_y = ta.getDimension(R.styleable.RoundedCornerImageView_topLeftRadius_y, 0);
        topRightRadius_x = ta.getDimension(R.styleable.RoundedCornerImageView_topRightRadius_x, 0);
        topRightRadius_y = ta.getDimension(R.styleable.RoundedCornerImageView_topRightRadius_y, 0);
        bottomLeftRadius_x = ta.getDimension(R.styleable.RoundedCornerImageView_bottomLeftRadius_x, 0);
        bottomLeftRadius_y = ta.getDimension(R.styleable.RoundedCornerImageView_bottomLeftRadius_y, 0);
        bottomRightRadius_x = ta.getDimension(R.styleable.RoundedCornerImageView_bottomRightRadius_x, 0);
        bottomRightRadius_y = ta.getDimension(R.styleable.RoundedCornerImageView_bottomRightRadius_y, 0);
